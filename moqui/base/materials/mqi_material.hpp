...
class material_t {
   ...
   public:
    ...
    CUDA_HOST_DEVICE
    material_t<R>& operator=(const material_t<R>& r) {
    ...
    ///< variable density
    CUDA_HOST_DEVICE
    inline virtual R mass_density(R scale = 1.0) const { return scale * rho_mass; }

    CUDA_HOST_DEVICE
    inline virtual R dedx_term0() const { return two_pi_re2_mc2_nel; }

    CUDA_HOST_DEVICE
    inline virtual R atomic_number() const { return Z; }
