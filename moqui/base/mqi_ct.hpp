...
class ct : public rect3d<int16_t, R> {
   ...
   public:
    ...
    virtual void load_data() {
        ...
        std::cout << "Reading DICOM directory.. : Patient CT pixel data successfully loaded."
                  << std::endl;
    }
    ...
    inline virtual R get_dx() { return dx_; }

    inline virtual R get_dy() { return dy_; }

    inline virtual R* get_dz() { return dz_; }

    inline virtual void set_dx(R dx) { dx_ = dx; }

    inline virtual void set_dy(R dy) { dy_ = dy; }

    inline virtual void set_dz(R* dz) { dz_ = dz; }
    inline virtual void set_data(R* dz) { dz_ = dz; }
