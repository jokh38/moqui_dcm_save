...
typedef enum { XM = 0, XP = 1, YM = 2, YP = 3, ZM = 4, ZP = 5, NONE_XYZ_PLANE = 6 } cell_side;

typedef enum { MASK = 0, VOLUME = 1 } aperture_type_t;

typedef enum { PER_BEAM = 0, PER_SPOT = 1, PER_PATIENT = 2 } sim_type_t;

typedef enum { APERTURE_CLOSE = 1, APERTURE_OPEN = 2, NORMAL_PHYSICS = 3 } transport_type;
